<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Username -->
        <div class="col-span-6 sm:col-span-4" style="color:red;">*you can not change your username.</div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="username" value="{{ __('Userame') }}" />
            <x-input id="username" type="text" class="mt-1 block w-full" wire:model.defer="state.username" autocomplete="username" disabled />
